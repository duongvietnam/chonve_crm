...
namespace Nop.Services.ExportImport.Help
{
    ...
    public class PropertyByName<T>
    {
        ...
        public PropertyByName(string propertyName, Func<T, object> func = null, bool ignore = false,string _format =null,bool _isSum=false)
        {
        ...
        /// <summary>
        /// Thiet dat format cell tren excel
        /// </summary>
        public string FormatValue { get; set; }
        /// <summary>
        /// Day dau truong nay co the sum
        /// </summary>
        public bool AllowSum { get; set; }

    }
    public class ConfigCellExcel
    {
