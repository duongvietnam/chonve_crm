...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        /// <summary>
        /// Lay thong tin theo nhan vien
        /// </summary>
        /// <param name="nhanVienId"></param>
        /// <returns></returns>
        Customer GetCustomerByNhanVienId(int nhanVienId);
        /// <summary>
        ...
        /// <summary>
        /// Lay role theo app module
        /// </summary>
        /// <param name="Module"></param>
        /// <returns></returns>
        IList<CustomerRole> GetAllTBOficesCustomerRoles(string Module);
        /// <summary>
