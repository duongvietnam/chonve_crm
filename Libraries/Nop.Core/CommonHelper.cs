...
namespace Nop.Core
{
    public static class CommonExtention
    {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public static string toStringApi(this DateTime? input, bool isWithTime = true)
        {
            if (isWithTime)
        ...
        public static string toStringApi(this DateTime input,bool isWithTime=true)
        {
            ...
            return input != DateTime.MinValue ? input.ToString("yyyy-MM-dd") : "";
        }
        /// <summary>
        ...
        /// <summary>
        /// Hien thi dang : 01 - 05/12/2020 or 01/11-10/12/2020
        /// </summary>
        /// <param name="day1"></param>
        /// <param name="day2"></param>
        /// <returns></returns>
        public static string toDayGroup(this DateTime? day1, DateTime? day2)
        {
            string ret = "";
            if (!day1.HasValue)
            {
                ...
                {
                    ret = ret + "-" + day2.toDateVNString();
                }
            }
            else
            {
                if (!day2.HasValue)
                    ret = day1.toDateVNString() + "-?";
                else
                {
                    //neu day 1 va 2 la cac ngay trong 1 thang thi :
                    //day 1: lay day
                    if (day1.Value.Month == day2.Value.Month && day1.Value.Year == day2.Value.Year)
                        ret = day1.Value.ToString("dd");
                    else if (day1.Value.Year == day2.Value.Year)
                        ret = day1.Value.ToString("dd/MM");
                    else
                        ret = day1.toDateVNString();
                    ret = ret + "-" + day2.toDateVNString();
                }
        ...
        public static string toDayGroup(this DateTime day1, DateTime? day2)
        {
            ...
            else
            {
                //neu day 1 va 2 la cac ngay trong 1 thang thi :
                //day 1: lay day
                if (day1.Month == day2.Value.Month && day1.Year == day2.Value.Year)
                    ret = day1.ToString("dd");
                else if (day1.Year == day2.Value.Year)
                    ret = day1.ToString("dd/MM");
                else
                    ret = day1.toDateVNString();
                ret = ret + "-" + day2.toDateVNString();
            }
        ...
        public static string ToVNStringPrice(this Object val)
        {
           
            return val.ToVNStringNumber()+ " ₫";
        }
        /// <summary>
        /// Chuyen doi dang so tu dang hien thi Viet Nam sang hien thi thap phan cua html, su dung trong viec edit so thap phan
        /// </summary>
        /// <param name="val"></param>
        /// <returns></returns>
        public static string ToFloatHtml(this Decimal val)
        {
            
            return val.ToVNStringNumber(true).Replace(",",".");
        }
        /// <summary>
        ...
        public static decimal ToRound2(this decimal val)
        {           
