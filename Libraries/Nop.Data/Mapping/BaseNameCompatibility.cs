...
namespace Nop.Data.Mapping
{
    ...
    public partial class BaseNameCompatibility : INameCompatibility
    {
        public Dictionary<Type, string> TableNames => new Dictionary<Type, string>
        {
            ...
            #region Register CRM 
            { typeof(CdChuyenDi), "CRM_CD_CHUYEN_DI" },
            { typeof(ChGiaTriThongTinMoRong), "CRM_CH_GIA_TRI_THONG_TIN_MO_RONG" },
            { typeof(ChPhanHangKhachHang), "CRM_CH_PHAN_HANG_KHACH_HANG" },
            { typeof(ChThongTinMoRong), "CRM_CH_THONG_TIN_MO_RONG" },
            { typeof(DmSuKien), "CRM_DM_SU_KIEN" },
            { typeof(DvDichVu), "CRM_DV_DICH_VU" },
            { typeof(DvDichVuCombo), "CRM_DV_DICH_VU_COMBO" },
            { typeof(DvDieuChinhGia), "CRM_DV_DIEU_CHINH_GIA" },
            { typeof(DvGiaDichVu), "CRM_DV_GIA_DICH_VU" },
            { typeof(DvLoaiDichVu), "CRM_DV_LOAI_DICH_VU" },
            { typeof(DvNhatKyGia), "CRM_DV_NHAT_KY_GIA" },
            { typeof(DvNhomDichVu), "CRM_DV_NHOM_DICH_VU" },
            { typeof(DvDonViTinh), "CRM_DV_DON_VI_TINH" },
            { typeof(GdGiaoDich), "CRM_GD_GIAO_DICH" },
            { typeof(GdGiaoDichDanhGia), "CRM_GD_GIAO_DICH_DANH_GIA" },
            { typeof(GdGiaoDichDiem), "CRM_GD_GIAO_DICH_DIEM" },
            { typeof(GdGiaoDichKhachHangMap), "CRM_GD_GIAO_DICH_KHACH_HANG_MAP" },
            { typeof(GdGiaoDichSub), "CRM_GD_GIAO_DICH_SUB" },
            { typeof(KhCauHinhMoRong), "CRM_KH_CAU_HINH_MO_RONG" },
            { typeof(KhDanhBaDienThoai), "CRM_KH_DANH_BA_DIEN_THOAI" },
            { typeof(KhKhachHang), "CRM_KH_KHACH_HANG" },
            { typeof(KhNhomHeThong), "CRM_KH_NHOM_HE_THONG" },
            { typeof(KhNhomHeThongMap), "CRM_KH_NHOM_HE_THONG_MAP" },
            { typeof(KhNhomKhachHang), "CRM_KH_NHOM_KHACH_HANG" },
            { typeof(KhNhomKhachHangMap), "CRM_KH_NHOM_KHACH_HANG_MAP" },
            { typeof(KhThongKeSuDungDichVu), "CRM_KH_THONG_KE_SU_DUNG_DICH_VU" },
            { typeof(KhThongTinMoRong), "CRM_KH_THONG_TIN_MO_RONG" },
            { typeof(MarDoanhThuMarketing), "CRM_MAR_DOANH_THU_MARKETING" },
            { typeof(MarEventMarketing), "CRM_MAR_EVENT_MARKETING" },
            { typeof(MarMaGiamGia), "CRM_MAR_MA_GIAM_GIA" },
            { typeof(MarMarketing), "CRM_MAR_MARKETING" },
            { typeof(MarMarketingDieuKien), "CRM_MAR_MARKETING_DIEU_KIEN" },
            { typeof(MarMarketingHeThong), "CRM_MAR_MARKETING_HE_THONG" },
            { typeof(MarMarketingHeThongMap), "CRM_MAR_MARKETING_HE_THONG_MAP" },
            #endregion
