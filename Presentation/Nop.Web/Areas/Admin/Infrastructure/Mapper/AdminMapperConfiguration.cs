...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        {
            CreateMap<WorkFiles, WorkfilesModel>()
                .ForMember(model => model.TenNguoiTao, o => o.MapFrom(e =>EngineContext.Current.Resolve<IDanhMucCacheService>().GetUserName(e.CustomerId)));
            CreateMap<WorkfilesModel, WorkFiles>();
