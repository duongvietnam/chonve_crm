...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class SecurityModelFactory : ISecurityModelFactory
    {
        ...
        public virtual PermissionMappingModel PreparePermissionMappingModel(PermissionMappingModel model, int RoleId = 0)
        {
            if (model == null)
            ...
            if (RoleId > 0)
                customerRoles = customerRoles.Where(c => c.Id == RoleId).ToList();
            model.RoleId = RoleId;
