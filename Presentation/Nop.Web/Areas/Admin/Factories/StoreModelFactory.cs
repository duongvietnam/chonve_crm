...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class StoreModelFactory : IStoreModelFactory
    {
        ...
        public IList<SelectListItem> PrepareSelectListStore(decimal? valSelected = 0, bool isAddFirst = false, string strFirstRow = "-- Chọn doanh nghiệp --", string valueFirstRow = "")
        {
            var _listItems = _storeService.GetAllStores();
