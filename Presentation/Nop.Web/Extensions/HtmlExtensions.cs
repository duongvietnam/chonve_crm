...
namespace Nop.Web.Extensions
{
    public static class HtmlExtensions
    {
        ...
        /// <summary>
        /// Hiện thị đường dẫn ảnh từ fileid
        /// </summary>
        /// <param name="fileId"></param>
        /// <returns></returns>
        public static string ToUrlImage(this int fileId)
        {
            return string.Format("/Workfiles/ViewImage?Id={0}", fileId);
        }
        public static string ToUrlDownload(this string guid)
        {
            return string.Format("/Workfiles/Download?guid={0}", guid);
        }
        public static string ToUrlDownload(this System.Guid guid)
        {
            return string.Format("/Workfiles/Download?guid={0}", guid);
        }
    }
