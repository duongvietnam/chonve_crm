            ...
            if (nopConfig.IsApiApplication)
            {
                ...
                .AddJwtBearer(x =>
                {
                    ...
                    x.TokenValidationParameters = new TokenValidationParameters
                    {
                        ...
                        IssuerSigningKey = new SymmetricSecurityKey(System.Text.Encoding.UTF8.GetBytes(nopConfig.ApiKeyEncrypt)),
                        ValidateIssuer = true,
                        ValidateAudience = true,
                        ValidAudience = nopConfig.ApiValidIssuer,
                        ValidIssuer = nopConfig.ApiValidIssuer,
