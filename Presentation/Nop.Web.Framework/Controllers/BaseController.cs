...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        protected virtual IActionResult AccessDeniedPartialView()
        {
        ...
        protected virtual JsonResult JsonSuccessMessage(string msg = "Ok", object objdata = null)
        {
            return Json(MessageReturn.CreateSuccessMessage(msg, objdata));
        }
        protected virtual JsonResult JsonErrorMessage(string msg = "Có lỗi", object objdata = null)
        {
            return Json(MessageReturn.CreateErrorMessage(msg, objdata));
        }
        protected virtual JsonResult JsonNotFoundMessage(string msg = "Không tìm thấy thông tin", object objdata = null)
        {
            return Json(MessageReturn.CreateErrorMessage(msg, objdata));
        }
        protected virtual JsonResult JsonDeniedMessage()
        {
            return Json(MessageReturn.CreateErrorMessage("Bạn không có quyền thao tác chức năng này"));
        }
        #endregion
    }
}