...
namespace Nop.Web.Framework.Mvc.Filters
{
    ...
    /// </summary>
    public class AuthorizeCRMAttribute : TypeFilterAttribute
    {
        #region Fields
        ...
        public AuthorizeCRMAttribute(bool ignore = false) : base(typeof(AuthorizeCRMFilter))
        {
        ...
        /// </summary>
        private class AuthorizeCRMFilter : IAuthorizationFilter
        {
            #region Fields
            ...
            public AuthorizeCRMFilter(bool ignoreFilter, IPermissionService permissionService)
            {
            ...
            public void OnAuthorization(AuthorizationFilterContext filterContext)
            {
                ...
                if (filterContext.Filters.Any(filter => filter is AuthorizeCRMFilter))
                {
