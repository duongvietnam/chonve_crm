...
namespace Nop.Web.Framework.TagHelpers.TBOffice
{
    /// <summary>
    /// nop-editor tag helper
    /// </summary>
    [HtmlTargetElement("tb-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class TBEditorTagHelper : TagHelper
    {
        private const string ForAttributeName = "asp-for";
        private const string CustomIdAttributeName = "asp-custom-id";
        ...
        [HtmlAttributeName(CustomIdAttributeName)]
        ...
        public TBEditorTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (!string.IsNullOrEmpty(CustomId))
                htmlAttributes.Add("id", CustomId);
