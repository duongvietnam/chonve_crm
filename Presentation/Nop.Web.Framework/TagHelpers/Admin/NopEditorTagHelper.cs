...
namespace Nop.Web.Framework.TagHelpers.Admin
{
    ...
    public class NopEditorTagHelper : TagHelper
    {
        ...
        private const string OffAutocompleteAttributeName = "asp-offautocomplete";
        private const string DonViTinhCustomize = "asp-dvtc";
        ...
        [HtmlAttributeName(OffAutocompleteAttributeName)]
        public string IsOffAutocomplete { set; get; }
        /// <summary>
        ...
        /// DonViTinh
        /// </summary>
        [HtmlAttributeName(DonViTinhCustomize)]
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //thiet dat off auto fill password
            bool.TryParse(IsOffAutocomplete, out bool offAutocomplete);
            if (offAutocomplete)
            {
            ...
            var htmlOutput = _htmlHelper.Editor(For.Name, Template, new { htmlAttributes, postfix = Postfix, donViTinh = DonViTinh });
